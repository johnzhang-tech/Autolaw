import svgPaths from "./svg-n3nnxuvfjd";
...
function InnerScreen() {
  return (
    <div className="-translate-x-1/2 absolute h-[453.1px] left-1/2 rounded-[11.935px] top-[12.31px] w-[648.757px]" data-name="Inner screen">
...
function Ipad() {
  return (
    <div aria-label="Visual chart illustrating a 78% increase in efficiency across 33 regions between 2021 and 2024, with clear upward trends year over year" className="-translate-x-1/2 -translate-y-1/2 absolute bg-black border-[#929292] border-l-[1.492px] border-r-[1.492px] border-solid border-t-[1.492px] h-[422.936px] left-[calc(50%+0.27px)] overflow-clip rounded-tl-[17.902px] rounded-tr-[17.902px] shadow-[0px_-2.984px_14.918px_0px_rgba(0,0,0,0.1)] top-[calc(50%-29.53px)] w-[676.548px]" data-name="Ipad">
      <InnerScreen />
    </div>
  );
}
...
function Header() {
  return (
    <header className="content-stretch flex flex-col gap-[140px] items-start max-w-[1600px] overflow-clip relative shrink-0 w-full" data-name="Header">
...
function LogoCloud() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-center max-w-[1600px] py-[50px] relative shrink-0 w-full" data-name="Logo cloud">
...
function Text() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="content-stretch flex flex-col gap-[50px] items-start pr-[200px] relative w-full whitespace-pre-wrap">
...
function HeroImage1() {
  return (
    <div className="h-[600px] relative rounded-[30px] shrink-0 w-full" data-name="Hero Image">
      <img alt="A image that shows a mountain range from above" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[30px] size-full" src={imgHeroImage} />
    </div>
  );
}
...
function ProductSection() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[1600px] pb-[120px] relative shrink-0 w-full" data-name="Product section">
      <HeadlineAndIcons />
      <HeroImage1 />
    </div>
  );
...
function Text5() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start mb-[-12px] pb-[80px] pt-[60px] relative shrink-0 w-full" data-name="Text">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-solid border-t inset-0 pointer-events-none" />
      <Title />
      <List />
      <Button />
...
function Image() {
  return (
    <div className="h-[744px] relative rounded-[30px] shrink-0 w-full" data-name="Image">
...
function FeaturesCarouselV() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[1600px] mb-[-12px] relative shrink-0 w-full" data-name="Features carousel v1">
      <Image />
    </div>
  );
}
...
function FeaturesCarousel() {
  return (
    <section className="content-stretch flex flex-col items-start max-w-[1500px] pb-[132px] relative shrink-0 w-full" data-name="Features carousel">
      <Text5 />
      <FeaturesCarouselV />
    </section>
  );
...
function Component3Up() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full" data-name="3-up">
      <Lockup />
      <Lockup1 />
      <Lockup2 />
    </div>
...
function HowItWorksSection() {
  return (
    <section className="content-stretch flex flex-col gap-[80px] items-start max-w-[1600px] pb-[120px] pt-[80px] relative shrink-0 w-full" data-name="How it works section">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-solid border-t inset-0 pointer-events-none" />
      <Frame3 />
      <Component3Up />
    </section>
...
function Image1() {
  return (
    <div className="flex-[1_0_0] h-[664.286px] min-h-px min-w-px relative" data-name="Image">
...
function ImageContainer() {
  return (
    <div aria-label="Image showing a winding path going up a mountain" className="content-stretch flex h-[664.286px] items-start max-h-[830.357177734375px] max-w-[1500px] overflow-clip relative rounded-[30px] shrink-0 w-full" data-name="Image container">
      <Image1 />
    </div>
  );
}
...
function HeroImage2() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[40px] relative shrink-0 w-full" data-name="Hero image">
      <ImageContainer />
    </div>
  );
}
  ...
  return (
    <section className="max-w-[1600px] relative shrink-0 w-full" data-name="Centered CTA">
      ...
      <div className="flex flex-col items-center max-w-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[40px] items-center max-w-[inherit] px-[100px] py-[120px] relative w-full">
...
function Footer() {
  return (
    <footer className="content-stretch flex flex-col gap-[80px] items-start justify-end max-w-[1600px] pb-[20px] pt-[40px] relative shrink-0 w-full" data-name="Footer">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-solid border-t inset-0 pointer-events-none" />
      <Links />
      <Credits />
    </footer>
...
export default function Tablet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center pb-[20px] px-[40px] relative size-full" data-name="Tablet">
      <NavItems />
      <Frame4 />
      <Header />
      <Main />
